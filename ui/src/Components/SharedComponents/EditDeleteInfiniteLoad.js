...
function EditDeleteInfiniteLoad(props) {
  const {
    //	data, // Data Source
  ...
  let handleDelete = useCallback(async (event) => {
  ...
  return (
    <div>
      <MasterTable
        ...
        height={"300px"}
        filterRow
        remoteOperations={remoteOperationsHandler}
        apiMethod={TABLE_DATA_API}
...
export default React.memo(EditDeleteInfiniteLoad);
