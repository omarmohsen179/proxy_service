...
import { GET_ACCOUNTS_PROFITS_REPORT } from "../API.ProfitsReport";

const AccountsProfitsTable = ({ apiPayload }) => {
  ...
  return (
    <>
      <MasterTable
        ...
        apiMethod={GET_ACCOUNTS_PROFITS_REPORT}
        columnChooser={false}
...
export default AccountsProfitsTable;
